...
public class HttpCookieOAuth2AuthorizationRequestRepository implements AuthorizationRequestRepository<OAuth2AuthorizationRequest> {
    ...
    public static final int COOKIE_EXPIRE_SECONDS = 1000 * 60 * 60 * 24; // One Day
...
/**
 * OAuth2 인증 과정 중에 파라미터(state, redirect_uri) 저장해야 함
 * -> 쿠키에 저장하기 위해 구현하는 클래스
 * 스프링 시큐리티 OAuth2 관련 필터(OAuth2AuthorizationRequestRedirectFilter, OAuth2LoginAuthenticationFilter)에서 인증 과정 중 호출됨
 *
