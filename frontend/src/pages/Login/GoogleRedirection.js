...
//   useEffect(() => {
//     // 3. Google OAuth 엔드포인트로 코드를 전송하여 사용자 정보를 받아오기
//     axios
//       .get(`http://localhost:3000/login/oauth2/code/google?code=${code}`)
//       .then((response) => {
...
//   // 8. Google 로그인 성공 시 화면에 표시할 UI 구현
//   return <div>Google 로그인 성공화면.</div>;
// };
